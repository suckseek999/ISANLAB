      ...
      <nav class="top-bar" data-topbar role="navigation">
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
            ...
            <li  class="active"><a href="blogTh.php">ข่าวสาร</a></li>
        ...
        ?>
            <div class="w3-content">
              <div class="w3-row w3-margin">
                ...
                <div class="w3-third">
                  <a href="<?php echo $row->Link; ?>"><img class="imgs" src="<?php echo $row->image; ?>" style="width:100%;min-height:200px"></a>
                </div>
