...
<html class="no-js" lang="en">
  ...
  <section class="top-bar-section">
    ...
    <ul class="right">
      ...
      <li class="active"><a href="contactTh.php">ติดต่อ</a></li>
      ...
      if ($searchq == null) {
        ...
        <?php
            ...
            ?>
                ...
                <h4><?php echo $row->NameTh; ?></h3>
                <h5><?php echo $row->biplomaTh; ?></h5>
                </div>
                
                <div class="large-4 medium-4 small-12 columns faq">
                <h5>ตำแหน่งทางวิชาการ : <?php echo $row->academicPositionTh; ?></h5>
                
                <h5>อีเมล : <?php echo $row->email; ?></h5>
                <h5>การวิจัย : <?php echo $row->researchInterestTh; ?></h5>
...
<div class="newsletter">
 ...
 <div class="foot-1">
 <h4>ที่อยู่</h4>
 <p>กลุ่มวิจัยความมั่นคงปลอดภัยสารสนเทศและเครือข่ายขั้นสูง (ISAN) คณะวิทยาการสารสนเทศ มหาวิทยาลัยมหาสารคาม ตำบลขามเรียง อำเภอกันทรวิชัย จังหวัดมหาสารคาม  44150<br>
  </p>
 <ul>
