      ...
      <nav class="top-bar" data-topbar role="navigation">
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
            ...
            <li class="active"><a href="researchprojrctTh.php">โครงการวิจัย</a></li>
  ...
  <div class="content-sec inner-sec ">
    <div class="row">
      ...
      ?>
          ...
          <h3><?php echo $row->TitleTh; ?></h3>
          

          </div>
          
          <div class="large-6 medium-6 small-12 columns faq">
          <h5><?php echo $row->FundingSourcesTh; ?></h5>
          <p><?php echo $row->PeriodTh; ?></p>
          <p><?php echo $row->AbstractTh; ?></p>
          <p>งบประมาณ :<?php echo $row->Budgetn; ?></p>
