                        ...
                        <?php
                           ...
                           <form method="post" name="frmUpdate" align="center" enctype="multipart/form-data" action="">
                                <div class="container blog-content p-1">
                                    <h5 class="border-short-bottom text-center" align="center">UPDATE CONTACT </h5>
                                </div>
                                ...
                                <input type="file" name="txtimage" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo  $row['Icon']; ?>">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
